const Russian = {
  ...
  PortfolioPage: {
    ...
    project_4:
      'В отчете представлен анализ продаж по дистрибьюторам, торговым точкам, торговым представителям, ABC анализ товаров и анализ темпов прироста продаж в динамике',
  },
  Review: {
    title: 'Отзывы',
    review_1: {
  ...
  Project_4: {
    title: 'Анализ работы дистрибьюторов',
  },
};
